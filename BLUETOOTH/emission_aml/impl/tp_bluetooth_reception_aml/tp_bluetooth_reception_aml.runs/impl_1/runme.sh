...
HD_PWD='/user/didouha/E4/P1/SEI_4101A/TP_BLUETOOTH/emission_aml/impl/tp_bluetooth_reception_aml/tp_bluetooth_reception_aml.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reception.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reception.tcl -notrace
