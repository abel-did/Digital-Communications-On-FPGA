...
HD_PWD='/user/didouha/E4/P1/SEI_4101A/TP_BLUETOOTH/emission_aml/impl/tp_bluetooth_emission_aml/tp_bluetooth_emission_aml.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log emission.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source emission.tcl
